...
function greeter(hour) {
    ...
    //a. <,>,<=,>= comparison operators and &&, || logical operators can be used to test the hour within the conditional statements
    //b. the last threshold can be a default(else) condition that automatically prints 'good night'
    //c. watch for case sensitivity 
